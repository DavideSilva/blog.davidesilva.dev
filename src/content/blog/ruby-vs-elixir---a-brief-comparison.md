...
description: >-
  In the world of tech startups, time is an essential factor in the success of a
  company. Who can deliver the best work in the shortest amount of time gains a
  competitive edge over the competition. Not only that but in a world in
  constant evolution, the need to quickly change gears and pivot a business idea
  into another opportunity is of great importance.
pubDatetime: 2021-05-16T23:00:00.000Z
tags:
  - Development
  - Elixir
  - Ruby on Rails
canonicalURL: 'https://blog.finiam.com/blog/ruby-vs-elixir'
---
